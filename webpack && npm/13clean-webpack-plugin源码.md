...
[参考](<https://www.webpackjs.com/contribute/writing-a-plugin/>)
...
var clean = function() {
  ...
  webpackDir = path.dirname(module.parent.filename);//这个文件路径就是webpack.config.js
